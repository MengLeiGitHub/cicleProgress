...
public class ChildViewPager extends ViewPager {
	...
	public ChildViewPagerStateChange getStateChange() {
		return stateChange;
	}

	public void setStateChange(ChildViewPagerStateChange stateChange) {
	...
	public void setListinfo() {
		...
		int image[]={com.example.cicleprogrossbar.R.drawable.image1,
				com.example.cicleprogrossbar.R.drawable.image2,
				com.example.cicleprogrossbar.R.drawable.image3,
				com.example.cicleprogrossbar.R.drawable.image4
		};
		
		if(acitvity==null)new Exception("activity  should not be null");
		
 		for (int i = 0; i<image.length; i++) {
			ImageView img = new ImageView(acitvity);
			Drawable draw=acitvity.getResources().getDrawable(
					image[i]);
		...
		viewpager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int arg0) {
				...
				if(stateChange!=null)
 				stateChange.drawCicle(listViews.size(),arg0%listViews.size());
			}
			...
			public boolean onTouch(View arg1, MotionEvent arg0) {
				...
				if (arg0.getAction() == MotionEvent.ACTION_UP) {
					...
					if (downP.x == curP.x && downP.y == curP.y) {
						onSingleTouch(viewpager.getCurrentItem()%listViews.size());
 					}
					isTouch=false;
	...
	protected void onMeasure(int arg0, int arg1) {
	    ...
	    int measuredHeight=(int)(getMeasuredWidth()*0.50282); 
