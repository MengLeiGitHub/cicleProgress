 ...
 *
 */
public class ChildViewPagerStateChange extends View {
	public ChildViewPagerStateChange(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onDraw(Canvas canvas) {
        ...
        int lastright = 0;
 		for (int i = 0; i < size; i++) {
			p.setColor(Color.parseColor("#BEBEBE"));
